    ...
    <Popover>
        ...
        >
          <div className="w-full flex items-center gap-2">
            ...
            <div className="truncate flex-1">
              {background ? background : 'Select Theme'}
            </div>
          </div>
        </Button>
      </PopoverTrigger>
      <PopoverContent className="w-64">
          ...
          <TabsContent value="solid" className="flex flex-wrap gap-1 mt-0">
            {solids.map((s, index) => (
              <div
                ...
                onClick={() => (setBackground(background), setColor(background), setBackground(s))}
              />
            ))}
          </TabsContent>
        ...
        <Input
          ...
          value={background}
          onChange={(e) => (setBackground(e.target.value), setColor(background), setBackground(e.target.value))}
        />
      </PopoverContent>
    </Popover>
  )
