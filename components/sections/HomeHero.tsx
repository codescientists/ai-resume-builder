...
const HomeHero = () => {
  ...
  return (
    <div
        ...
        <h1
        className="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-white-300 dark:text-gray-300 sm:text-5xl">
        Revolutionize Your Resume <br />
        ...
        Start creating your AI-powered resume for your next job role in minutes. Let our smart builder tailor the perfect CV, designed to make an impact.
        </h2>
        <a
            className="mt-8 inline-block w-auto text-center min-w-[200px] px-6 py-4 text-white transition-all rounded-md shadow-xl sm:w-auto bg-gradient-to-r from-orange-600 to-orange-500 hover:bg-gradient-to-b dark:shadow-orange-900 shadow-orange-200 hover:shadow-2xl hover:shadow-orange-400 hover:-tranneutral-y-px "
            href={`${ userId ? '/dashboard' : '/sign-up'}`}>Build My Resume
        </a>
    </div>
  )
}
